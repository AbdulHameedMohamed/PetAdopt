...
data class CachedPhoto(
    ...
    companion object {
        fun fromDomain(animalId: Long, photo: com.example.petadopt.common.domain.model.animal.Media.Photo): CachedPhoto {
    ...
    fun toDomain(): com.example.petadopt.common.domain.model.animal.Media.Photo = com.example.petadopt.common.domain.model.animal.Media.Photo(medium, full)
}