package com.example.petadopt.animals.data.preferences
...
import com.example.petadopt.animals.data.preferences.PreferencesConstants.KEY_TOKEN
import com.example.petadopt.animals.data.preferences.PreferencesConstants.KEY_TOKEN_EXPIRATION_TIME
import com.example.petadopt.animals.data.preferences.PreferencesConstants.KEY_TOKEN_TYPE

@Singleton
class PetAdoptPreferences @Inject constructor(
    @ApplicationContext context: Context
) : Preferences {

    companion object {
        const val PREFERENCES_NAME = "PET_ADOPT_PREFERENCES"
    }
